...
echo "gitstandup.vim.vim: VimL code executing."

function LuaDoItVimL()
    echo "gitstandup.vim.vim LuaDoItVimL(): hello"
endfunction
...
lua <<EOF
    function lua_do_it_lua()
        print("gitstandup.vim.vim lua_do_it_lua(): hello")
    end

    print "gitstandup.vim.vim: Lua code executing."
EOF
